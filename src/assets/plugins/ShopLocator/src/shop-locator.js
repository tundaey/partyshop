...
;(function ( $, window, document, undefined ) {
    ...
    var path =  "assets/plugins/ShopLocator/src";
    var pluginName = "ShopLocator",
        defaults = {
            ...
            infoBubble:{
                ...
                closeSrc: "" + path + "/style/closeButton.svg",
                offsetTop: 2,
                offsetRight: 2,
            ...
            markersIcon: "" + path + "/style/lollipop/images/marker.png",
            marker: {
            ...
            cluster:{
                ...
                style:{
                    ...
                    heightBIG: 60,
                    widthBIG: 54,
                    iconSmall: "" + path + "/style/lollipop/images/clusterSmall.png",
                    iconMedium: "" + path + "/style/lollipop/images/clusterMedium.png",
                    iconBig: "" + path + "/style/lollipop/images/clusterBig.png"
                }
            },
            sidebar:{
                visible: false,
